...
from apps.api.views.reserve_views import ReservesListApiView, ReservesDetailApiView, ReservesListApiViewDate
...
urlpatterns = [
    ...
    path('reserves/', ReservesListApiView.as_view(), name='reserves_list_view'),
    path('reserves/<int:year>-<int:month>-<int:day>/', ReservesListApiViewDate.as_view(),
         name='reserves_view-by-day'),
    path('reserves/<int:id>', ReservesDetailApiView.as_view(),
         name='reserves_detail_view'),

    path('doctypes/', DoctypeApiView.as_view(), name='doctypes_list_view'),
    path('cartypes/', CartypeApiView.as_view(), name='cartypes_list_view'),
    path('revtypes/', RevisiontypeApiView.as_view(),
         name='revisiontypes_list_view'),
